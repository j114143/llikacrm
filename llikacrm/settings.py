"""
Django settings for llikacrm project.
...
SECRET_KEY = '7_l@39%g=@&tp@qxb-v7+($))msn$4i37ykej7xp+nknfwmwhv'
...
WSGI_APPLICATION = 'llikacrm.wsgi.application'
